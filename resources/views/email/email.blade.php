                            ...
                            <tr>
                                <td>
                                    <div class="text" style="padding: 0 3em; text-align: center;color: black;">
                                        ...
                                        <p>đây là email để kích hoạt tài khoản {{$data->email}}</p>
                                        </span></b>
                                        </p>
                                        <button
                                            style="background-color:#C46F01;border:none;width: 150px;height: 40px;color: #fff;border-radius: 8px;"><a href="{{route('users.edit', ['id' => $data->id])}}" style="color: #fff;text-decoration: none">Kích hoạt tài khoản</a></button>
